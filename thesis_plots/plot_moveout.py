...
for i in np.arange(len(station_45)):
    ...
    if i == 0: 
        ...
        plt.plot(data_135[:,0], data_135[:,n], linewidth = lwidth, color = c2, linestyle = l2, alpha = 0.65)
        plt.plot(data_225[:,0], data_225[:,n], linewidth = lwidth, color = c3, linestyle = l3, alpha = 0.95)
        plt.plot(data_315[:,0], data_315[:,n], linewidth = lwidth, color = c4, linestyle = l4, alpha = 0.95)
        ...
        plt.plot(data_135[:,0], data_135[:,n] + i*dx, linewidth = lwidth, color = c2, linestyle = l2, alpha = 0.65)
        plt.plot(data_225[:,0], data_225[:,n] + i*dx, linewidth = lwidth, color = c3, linestyle = l3, alpha = 0.95)
        plt.plot(data_315[:,0], data_315[:,n] + i*dx, linewidth = lwidth, color = c4, linestyle = l4, alpha = 0.95)
    ticks [i] = dx*i

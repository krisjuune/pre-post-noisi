...
# Transform from geographic to geocentric
# Input argument is the geographic latitude, output geocentric latitude
def geograph_to_geocent(theta):
    # https://en.wikipedia.org/wiki/Latitude#Geocentric_latitude
    e_2 = wgs84()[2] # returns the 3rd item from function ouputs as start indexing from 0
